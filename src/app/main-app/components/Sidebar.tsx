...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col bg-black text-white rounded-full h-[800px] w-[100px] items-center justify-center absolute left-10 top-20">
      <div className="flex flex-col h-full py-10 justify-between">
        ...
        /> */}
          <Link href={""} onClick={() => handlePage("Home")}>
            <House
              size={44}
              className=" p-2 rounded-full hover:bg-white hover:text-black cursor-pointer transition-all duration-200 ease-in-out"
            />
          </Link>
